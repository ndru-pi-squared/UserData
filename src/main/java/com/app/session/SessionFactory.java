...
public class SessionFactory {
    ...
    public static UserSession createUserSession(LocalDateTime sessionStartTime, String userId, UserRole role) {
        return new UserSession(sessionStartTime, userId, role);
    }
